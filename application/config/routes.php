...
$route['admin/competitions'] = 'admin_competitions/index';
$route['admin/competitions/add'] = 'admin_competitions/add';
$route['admin/competitions/update'] = 'admin_competitions/update';
$route['admin/competitions/update/(:any)'] = 'admin_competitions/update/$1';
$route['admin/competitions/delete/(:any)'] = 'admin_competitions/delete/$1';
$route['admin/competitions/(:any)'] = 'admin_competitions/index/$1'; //$1 = page number
